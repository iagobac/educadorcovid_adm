    ...
    <div class="container-fluid" class="footer">
        <div class="row">
            <div class="col-12 text-center">
                <div class="footer">
                    <hr>
                    <span id="text-footer">&reg; Copyrigth by PREFEITURA MUNICIPAL DO CRATO - Secretaria Municipal de Educação  <br>EDUCACRATO - Sistema Integrado de Gestão da Educação Municipal.</span>
                </div>
            </div>
        </div>
    </div>
...
<script src="include/js/educacrato.js"></script>
...
<script type="text/javascript">
    ...
    $('#btnUnidadeTrabalho').click(function () {
        //close('tela_Escola_Unidade_trabalho');
        tabs.addTab({
            title: 'Unidade de Trabalho',
            id: 'tela_Escola_Unidade_trabalho',
            ajaxUrl: 'index.php/Escola_Unidade_trabalho'
        });

    });
    $('#btnLocaldeFuncionamento').click(function () {
        //close('tela_Escola_Local_funcionamento');
        tabs.addTab({
            title: 'Local de Funcionamento',
            id: 'tela_Escola_Local_funcionamento',
            ajaxUrl: 'index.php/Escola_Local_funcionamento'
        });
    });
    $('#btnorganizacao_ensino').click(function () {
        //close('tela_Escola_Local_funcionamento');
        tabs.addTab({
            title: 'Organização de Ensino',
            id: 'tela_Organizacao_ensino',
            ajaxUrl: 'index.php/Organizacao_ensino'
        });
    });
    $('#btnListarSevidores').click(function () {
        //close('tela_Escola_Local_funcionamento');
        tabs.addTab({
            title: 'Servidores',
            id: 'tela_Servidores',
            ajaxUrl: 'index.php/Servidor'
        });
    });
    $('#btnLotacao').click(function () {
        //close('tela_Escola_Local_funcionamento');
        tabs.addTab({
            title: 'Lotação',
            id: 'tela_Lotacao',
            ajaxUrl: 'index.php/Lotacao'
        });
    });

    $('#btnListarTurmas').click(function () {
        //close('tela_Escola_Unidade_trabalho');
        tabs.addTab({
            title: 'Turmas',
            id: 'tela_Turmas',
            ajaxUrl: 'index.php/Turma'
        });

    });


    function datatableDinamic(nameTable, nameArquivo = 'EDUCACRATO', rowordem = 0, ordem = 'asc'){
