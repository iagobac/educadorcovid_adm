...
<div class="table-responsive-sm">
    <table id="head_tabela_inscricao_todas" class="table table-sm table-striped table-bordered table-sm">
        ...
        <tbody>
            <?php preencher_tabela_inscricao_todas($inscricoes); ?>
        </tbody>
        <tfoot>
            <tr>
                <th scope="col" class="text-center column-invisivel" style="width: 5%">CÓDIGO</th>
...
<script>
    ...
    $(document).ready(function () {
        datatableDinamic("head_tabela_inscricao_todas");
    });
